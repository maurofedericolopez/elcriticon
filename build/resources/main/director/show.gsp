...
<html>
    ...
    <body>
        ...
        <div id="show-director" class="content scaffold-show" role="main">
            ...
            <f:display bean="director" />
            </ol>
            <g:form resource="${director}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${director}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
