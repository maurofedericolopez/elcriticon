...
<html>
    ...
    <body>
        ...
        <div id="show-pelicula" class="content scaffold-show" role="main">
            ...
            <f:display bean="pelicula" />
            </ol>
            <g:form resource="${pelicula}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${pelicula}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
