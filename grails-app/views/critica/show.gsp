...
<html>
    ...
    <body>
        ...
        <div id="show-critica" class="content scaffold-show" role="main">
            ...
            <f:display bean="critica" />
            </ol>
            <g:form resource="${critica}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${critica}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
